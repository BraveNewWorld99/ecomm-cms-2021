 ...
 *
 */
//TODO Need to update this section to match database updates
?>
...
$sec = new Sec;
$newToken = $sec->generateFormToken('deleteUser');
    ...
    <form action="admin.php?action=<?php echo $results['formAction']?>" method="post">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="title" id="title" placeholder="Title" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="first_name" id="first_name" placeholder="First Name" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="last_name" id="last_name" placeholder="Last Name" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="email" id="email" placeholder="Email" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="address1" id="address1" placeholder="Address 1" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="address2" id="address2" placeholder="Address 2" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="city" id="city" placeholder="City" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="state" id="state" placeholder="State" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="country" id="country" placeholder="Country" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="zip_code_post_code" id="zip_code_post_code" placeholder="Zip Code" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="phone" id="phone" placeholder="Phone" required autofocus maxlength="255" readonly
            ...
            <li>
                ...
                <input type="text" name="secret" id="secret" placeholder="Secret" required autofocus maxlength="255" readonly
